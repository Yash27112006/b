class Mail{
    ...
    sendMail(){
       this.from.position(windowWidth/2-235,windowHeight/2-200);
       this.myTextArea.position(windowWidth/4-30,windowHeight/2-100);
       this.button.position(windowWidth/2+240,windowHeight/2+100);
